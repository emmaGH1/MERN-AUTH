...
const RegisterScreen = () => {
    ...
    return (<FormContainer_1.default>
        ...
        <react_bootstrap_1.Form onSubmit={submitHandler}>
            <react_bootstrap_1.Form.Group className='my-2' controlId='name'>
            <react_bootstrap_1.Form.Label>Name Address</react_bootstrap_1.Form.Label>
            <react_bootstrap_1.Form.Control type='text' placeholder='Enter Name' value={name} onChange={(e) => setName(e.target.value)}></react_bootstrap_1.Form.Control>
            ...
            <react_bootstrap_1.Form.Group className='my-2' controlId='confirmPassword'>
